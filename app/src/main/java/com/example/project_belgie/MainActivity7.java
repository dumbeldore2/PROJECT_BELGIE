...
public class MainActivity7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //araylisten conecten
        arrayList = database.Table_6_col_1_tot_18();
        ...
        color_changer_fun(textView20,17);
    ...
    public void click_3(){
        textView3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                database.setTable_6_col_1_tot_18(arrayList);
            }
        });
    }  public void click_4(){
    ...
    public void click_19(){
        textView19.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (arrayList.get(16).equals("false")){
                    arrayList.set(16,"true");
                    color_changer_fun(textView19,16);
                }   else    {
    ...
    public void click_20(){
        textView20.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (arrayList.get(17).equals("false")){
                    arrayList.set(17,"true");
                    color_changer_fun(textView20,17);
                }   else    {
                    arrayList.set(17,"false");
                    color_changer_fun(textView20,17);
                }
                database.setTable_6_col_1_tot_18(arrayList);
            }
    ...
    public void color_changer_fun(TextView textView , int id){
        if (arrayList.get(id).equals("true")){
            textView.setBackgroundResource(R.drawable.border_6);
        } else {
